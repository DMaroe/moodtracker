...
var require_debug = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = typeof processModule === "object" && processModule.env && processModule.env.NODE_DEBUG && /\bsemver\b/i.test(processModule.env.NODE_DEBUG) ? (...args) => console.error("SEMVER", ...args) : () => {};
}));
//#endregion
...
//#endregion
export { require_gte as n, require_coerce as r, require_satisfies as t };
