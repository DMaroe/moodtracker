...
//#region node_modules/error-stack-parser-es/dist/lite.mjs
...
var FIREFOX_SAFARI_STACK_REGEXP, CHROME_IE_STACK_REGEXP, SAFARI_NATIVE_CODE_REGEXP;
var init_lite = __esmMin((() => {
	FIREFOX_SAFARI_STACK_REGEXP = /(^|@)\S+:\d+/;
	CHROME_IE_STACK_REGEXP = /^\s*at .*(\S+:\d+|\(native\))/m;
	SAFARI_NATIVE_CODE_REGEXP = /^(eval@)?(\[native code\])?$/;
}));
//#endregion
//#region node_modules/error-stack-parser-es/dist/index.mjs
...
//#endregion
export { parse as n, init_dist as t };
