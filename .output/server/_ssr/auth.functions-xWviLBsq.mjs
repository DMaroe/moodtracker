...
import { t as getServerFnById } from "../__23tanstack-start-server-fn-resolver-o2Jk9ZDA.mjs";
import processModule from "node:process";
//#region node_modules/.nitro/vite/services/ssr/assets/auth.functions-xWviLBsq.js
...
function getExpectedPasscode() {
	...
	const passcode = ctx?.cloudflare?.env?.APP_PASSCODE || ctx?.env?.APP_PASSCODE || globalThis?.__env__?.APP_PASSCODE || processModule.env.APP_PASSCODE;
	if (!passcode) {
