...
import { i as logout } from "./auth.functions-xWviLBsq.mjs";
import { r as saveMoodEntry, t as analyzeMood } from "./mood.functions-0eRV5oU9.mjs";
import { n as setCurrent } from "./mood-storage-B3Y3ZBxr.mjs";
import { t as nanoid } from "../_libs/nanoid.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-DTnWCpvo.js
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("textarea", {
								...
								className: `flex justify-end text-xs mt-2 ${overLimit ? "text-destructive" : "text-diary-ink/40"}`,
								children: [
									wordCount,
									" ",
