...
import { n as listMoodEntries } from "./mood.functions-0eRV5oU9.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/history-DIN1vYHq.js
						...
						return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										className: `text-diary-ink/40 text-sm transition-transform ${isExpanded ? "rotate-180" : ""}`,
										children: "▾"
									})
								]
							}), isExpanded && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "mt-4 pt-4 border-t border-diary-ink/10 space-y-3",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									className: "text-[10px] uppercase tracking-wide text-diary-ink/40 mb-1",
									children: "Your entry"
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "text-sm text-diary-ink/80 whitespace-pre-wrap",
									children: e.text
